...
//			SANDBOX_SPEED(initialization state, system function, libftmy function)
...
//			SANDBOX_SPEED(initialization state, system function, libftmy function) but use the bench type variable to raise display
